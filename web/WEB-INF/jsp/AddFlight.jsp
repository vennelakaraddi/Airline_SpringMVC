...
<div id="wrapper">
	...
	<div id="splash">
		<img class="pic" src="${pageContext.request.contextPath}/resources/images/investor.jpg" width="870" height="230" alt="" />
			...
			<center>
<form:form method="post" action="AddFlightAction" modelAttribute="AddFlight">
<br/>
   <h2><b>Add New Flight Details Screen</b></h2><br/>
   ...
   <center><font face=verdana color=red>${msg}</center></font>
		  ...
		  <td><form:errors path="price" cssClass="error"/></td>
			...
			<tr><td></td><td><input type="submit" value="Add Flight">
			</td>
			</table>
			</form:form>
				</div>	
